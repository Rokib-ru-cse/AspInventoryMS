...
namespace InventoryMS.Areas.Admin.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Product,Quantity,Date")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Product,Quantity,Date")] Sale sale)
        {
            if (id != sale.Id)
            {
                return NotFound();
